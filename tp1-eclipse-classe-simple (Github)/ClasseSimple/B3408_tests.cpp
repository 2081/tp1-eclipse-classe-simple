...
Tests::Tests()
{
	...
	Afficher(i++,T04(),"Liste vide, avec pszDMP");
	Afficher(i++,T05(),"Liste non vide ne contenant pas l'element, avec pszDMP");
	Afficher(i++,T06(),"Liste non vide ne contenant pas l'element, avec des elements redondants, avec pszDMP");
	Afficher(i++,T07_1(),"Element une fois dans la liste (premier)");
	Afficher(i++,T07_2(),"Element une fois dans la liste (milieu)");
	Afficher(i++,T07_3(),"Element une fois dans la liste (dernier)");
	Afficher(i++,T08(),"Element plusieurs fois dans la liste");
	Afficher(i++,T09(),"pszDMP vide");
